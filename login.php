...
>
    ...
    <h1 class=" text-center pb-5 pt-5 display-4">Login Doctor</h1>
...
<div class="mb-3">
  ...
  <button  class="btn btn-primary"><a style="text-decoration: none; color:white" href="admin/login.php">Login As Admin</a></button>
